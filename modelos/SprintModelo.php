...
class SprintModelo{
    ...
    public function crearSprint($nombreSprint, $fechaInicioSprint, $fechaFinSprint, $valorDiaLaboral, $totalDiashabiles, $totalHorasHabiles){
        $sql="INSERT INTO tb_sprint(nombre_sprint, fecha_inicio_sprint, fecha_fin_sprint, valor_dia_laboral, total_diashabiles, total_horashabiles)
            VALUES('$nombreSprint', '$fechaInicioSprint', '$fechaFinSprint', '$valorDiaLaboral', '$totalDiashabiles', '$totalHorasHabiles')";
