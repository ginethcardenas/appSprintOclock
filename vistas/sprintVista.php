        ...
        <div class="row">
                ...
                <div class="modal-body">
                  <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                    ...
                    <div class="form-group" bis_skin_checked="1">
                      <input type="text" class="form-control text-black" name="nameNombreSprint" required placeholder="Ingresa el nombre del sprint">
                    </div>
                    <label>Fecha inicio sprint</label>
                    <div class="form-group" bis_skin_checked="1">
                      <input type="date" class="form-control text-black" name="namefechaInicioSprint" required placeholder="Ingresa la fecha de inicio">
                    </div>
                    <label>Fecha fin sprint</label>
                    <div class="form-group" bis_skin_checked="1">
                      <input type="date" class="form-control text-black" name="namefechafinSprint" required placeholder="Ingresa la fecha de fin">
                    </div>
                    <label>Valor dia laboral</label>
                    <div class="form-group" bis_skin_checked="1">
                      <input type="number" class="form-control text-black" name="nameDiaLaboral" id="validacionInput" max="12" required placeholder="Ingresa dia laboral(horas)">
                      <label id="max-error" class="error" for="validacionInput">El maximo en horas es 12.</label>
                    </div>                     
                </div>
          ...
          <div class="card " bis_skin_checked="1">
            <div class="card-header" bis_skin_checked="1">
              <!-- <h4 class="card-title text-center">LISTA SPRINTS</h4> -->
            </div>
                ...
                <table class="table tablesorter tablesorter-default tablesorter40aa79c05efc1" id="simple-table" role="grid">
                  <thead class=" text-primary">
                    <tr role="row" class="tablesorter-headerRow">
                      ...
                      <th data-column="5" class="tablesorter-header tablesorter-headerUnSorted" tabindex="0" scope="col" role="columnheader" aria-disabled="false" aria-controls="simple-table" unselectable="on" aria-sort="none" aria-label="City: No sort applied, activate to apply an ascending sort" style="user-select: none;">
                        <div class="tablesorter-header-inner" bis_skin_checked="1">
                          Total Horas Habiles
                        </div>
                      </th>
                      <th data-column="6" class="tablesorter-header tablesorter-headerUnSorted" tabindex="0" scope="col" role="columnheader" aria-disabled="false" aria-controls="simple-table" unselectable="on" aria-sort="none" aria-label="City: No sort applied, activate to apply an ascending sort" style="user-select: none;">
                        <div class="tablesorter-header-inner" bis_skin_checked="1">
                          Acciones
                        </div>
                      </th>
                  ...
                  <tbody aria-live="polite" aria-relevant="all">
                    <?php foreach ($sprints as $sprint) { ?>
                      <tr role="row">
                        ...
                        <td>
                          <?php echo $sprint['valor_dia_laboral']; ?>
                        </td>
                        <td>
                          <?php echo $sprint['total_diashabiles']; ?>
                        </td>
                        <td>
                          <?php echo $sprint['total_horashabiles']; ?>
                        </td>
                        <td>
                          <!-- botonEditar -->
